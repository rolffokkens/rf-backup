...
install-common:
	...
	$(DESTDIR)/etc/cron.d $(DESTDIR)/var/lib/rf-backup
	...
	install -m 755 check-backups.sh $(DESTDIR)/usr/share/rf-backup/check-backups.sh
	...
	install -m 644 crontab $(DESTDIR)/etc/cron.d/rf-backup
